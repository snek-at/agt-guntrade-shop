...
async function getImageBase64({ imageAddress, directory, contentDigest, }) {
    ...
    return async function resolveGatsbyImageData(image, _a) {
        ...
        const generateImageSource = (filename, width, height, toFormat) => {
            return {
                ...
                placeholder: ``,
                format: toFormat,
                src: (0, get_shopify_image_1.urlBuilder)({
                    width,
                    height,
                    baseUrl: filename,
                    format: toFormat,
        ...
        if (remainingOptions && remainingOptions.placeholder === `BLURRED`) {
            ...
            const lowResImageURL = (0, gatsby_plugin_image_1.getLowResolutionImageURL)(Object.assign(Object.assign({}, remainingOptions), { aspectRatio: remainingOptions.width / remainingOptions.height, // Workaround - fixes height being NaN; we can remove this once gatsby-plugin-image is fixed
                formats,
                layout,
        ...
        return (0, gatsby_plugin_image_1.generateImageData)(Object.assign(Object.assign({}, remainingOptions), { formats,
            layout,
            sourceMetadata, pluginName: `gatsby-source-shopify`, filename: image.originalSrc, generateImageSource }));
    };
}
